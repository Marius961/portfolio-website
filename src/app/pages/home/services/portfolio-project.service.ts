  ...
  private readonly portfolioProjects: Array<PortfolioProject> = [
    {
      ...
      description: 'Company website. Several pages about the company and the field of activity, a blog with useful articles about the life of the company and IT, a page with vacancies, and a form for contacting the company. On this project I was engaged in layout and implementation of functionality for the following pages: "Hire developer", "Dedicated team", "Portfolio", "Blog", "Career" and also admin. panel for site management.',
      year: '2020',
